...
public class NtpMessage {
	...
	public static String timestampToString(double timestamp)
	{
        ...
        /**
	 * Returns the number of seconds since 00:00 1-Jan-1900, for a given date
         * formatted as yyyy-MM-dd HH:mm:ss.ssssss
	 */
	public static double timestampToDouble(String time)
	{
		
               double milliseconds=Double.valueOf(time.substring(20))/1000;

                SimpleDateFormat dateFormat = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
                Date fecha = null;
                try {
                  fecha=dateFormat.parse(time.substring(0, 19));
                } catch (Exception ex) {
                  
                }
                return (fecha.getTime()+milliseconds+2208988800000.0)/1000;
        }
